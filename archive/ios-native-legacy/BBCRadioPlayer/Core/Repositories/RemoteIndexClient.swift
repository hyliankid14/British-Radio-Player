...
struct RemoteIndexClient {
    static let indexURL = URL(string: "https://bbc-radio.shai.website/data/podcast-index.json.gz")!
    static let metaURL = URL(string: "https://bbc-radio.shai.website/data/podcast-index-meta.json")!
