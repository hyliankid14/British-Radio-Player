    ...
    private fun startForegroundNotification() {
        ...
        val favoriteAction = if (currentStationId.startsWith("podcast_") && !PlaybackStateHelper.getCurrentEpisodeId().isNullOrEmpty()) {
            ...
            val notificationBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSubText(showDesc)
            // use the app launcher icon so the status bar shows our logo instead of a blank
...
val pbShow = PlaybackStateHelper.getCurrentShow()
                    ...
                    val nb = NotificationCompat.Builder(this, CHANNEL_ID)
                        ...
                        .setContentText(notificationContentText)
                        .setSubText(showDesc)
                        // app icon gives a visible status bar indicator on newer Android versions
                        .setSmallIcon(R.mipmap.ic_launcher)
                        .setLargeIcon(bitmap)
                        .setContentIntent(pendingIntent)
                        .setOngoing(true)
    ...
    private fun updateNotificationProgressOnly() {
        try {
            ...
            val builder = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSubText(showDesc)
                // use the launcher icon so the notification is visible in the status bar
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentIntent(pendingIntent)
                .setOngoing(true)
                .setSound(null)
